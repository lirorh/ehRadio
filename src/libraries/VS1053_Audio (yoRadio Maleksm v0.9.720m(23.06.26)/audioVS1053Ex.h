...
//    void     computeVUlevel();
//    void     loadUserCode();
//    void streamModeOn();				// Streaming Mode On
//    void streamModeOff();				// Default: Streaming Mode Off
...
//    void             setBalance(float balance = 0.0f);
    ...
    /* VU METER */
    uint16_t     getVUlevel();
//    uint16_t     getVUlevel(uint16_t dimension);
    void           setVUmeter();
...
//    const uint8_t SM_ADCPM_HP = 13;
    ...
    const char volumetable[22]={   0,50,60,65,70,75,80,82,84,86, 88,90,91,92,93,94,95,96,97,98,99,100}; //22 elements
...
/*  public:
    struct audioSettings {
        ...
        uint16_t FREQ_HS_HZ = 5000;            // IIR Filter, highshelf
