...
const ScrollConfig title1Conf     PROGMEM = {{ TFT_FRAMEWDT, 48, 2, WA_LEFT }, 140, true, MAX_WIDTH-TITLE_FIX, SCROLLDELAY, 2, SCROLLTIME };
const ScrollConfig title2Conf     PROGMEM = {{ TFT_FRAMEWDT, 72, 2, WA_LEFT }, 140, true, MAX_WIDTH-TITLE_FIX, SCROLLDELAY, 2, SCROLLTIME };
...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 87, 2, WA_LEFT }, 140, true, MAX_WIDTH, 0, 2, SCROLLTIME };
