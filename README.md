...
| Date       | Release Notes    |
| ---------- | ---------------- |
| 2026.06.07 | Fixed Search/Curated additions corrupting the playlist, changing stations interrupts reconnect attempts, safe mode entered after unsuccessful boot (disables smartstart, autoupdate) |
