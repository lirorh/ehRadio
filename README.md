...
| Date       | Release Notes    |
| ---------- | ---------------- |
| 2026.06.18 | WebUI files now served from PSRAM cache (if available) which eliminates audio stuttering for I2S decoders, some other adjustments to PSRAM-related code |
