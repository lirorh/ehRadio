/*************************************************************************************
    ...
    Copy this file to src/displays/conf/displaySSD1305conf_custom.h
    and modify it
...
const ScrollConfig weatherConf    PROGMEM = {{ 0, 64-11, 1, WA_LEFT }, 140, true, DSP_WIDTH-6*4, 0, 2, 25 }; // ??????!!
...
const WidgetConfig clockConf      PROGMEM = { TFT_FRAMEWDT, 54, 0, WA_LEFT };
